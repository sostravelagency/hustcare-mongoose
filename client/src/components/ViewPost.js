                ...
                <div className="px-9">
                    ...
                    <div className="flex">
                        <div className="w-[65%] py-4 flex flex-col gap-2  ">
                            ...
                            <input readOnly value={post.overviewId?.type} type='text' id="additional-address" className='outline-none border border-gray-400 w-full rounded-md py-1 px-2 focus:border-blue-500' />
                            ...
                            <div className='w-1/2'>
                                ...
                                <input readOnly value={post.userId?.name} type='text' id="additional-address" className='outline-none border border-gray-400 w-full rounded-md py-1 px-2 focus:border-blue-500' />
                                <label className='font-semibold' htmlFor="additional-address">Điện thoại</label>
                                <input readOnly value={post.userId?.phone} type='text' id="additional-address" className='outline-none border border-gray-400 w-full rounded-md py-1 px-2 focus:border-blue-500' />
                                <label className='font-semibold' htmlFor="additional-address">Giá cho thuê</label>
                                <input readOnly value={post.attributeId?.price} type='text' id="additional-address" className='outline-none border border-gray-400 w-full rounded-md py-1 px-2 focus:border-blue-500' />
                                <label className='font-semibold' htmlFor="additional-address">Diện tích</label>
                                <input readOnly value={post.attributeId?.acreage} type='text' id="additional-address" className='outline-none border border-gray-400 w-full rounded-md py-1 px-2 focus:border-blue-500' />
                                <label className='font-semibold' htmlFor="additional-address">Đối tượng cho thuê</label>
                                <input readOnly value={post.overviewId?.target} type='text' id="additional-address" className='outline-none border border-gray-400 w-full rounded-md py-1 px-2 focus:border-blue-500' />
                            </div>
                            <div className='w-full' >
                                ...
                                <div className="w-full">
                                    <div>
                                        <div className="flex gap-4 items-center flex-wrap">
                                            {/* {console.log(post.imageId?.[0])} */}
                                            {JSON.parse(post.imageId?.[0]?.image)?.map(item => (
                                ...
                                {/* <SliderCustom images={post && JSON.parse(post?.imageId)} /> */}
                            </div>
